    ...
    <h2 id="mywork">My Work</h2>
      <ul className= "jjb07">
        ...
        <li className= "dropdown"> 
         ...
         <li className= "dropdown"> 
            <img className="prework dropbtn" alt="prework img" src={IconWa}
         ...
         <li className= "dropdown"> 
          <img className="prework dropbtn" alt="prework img" src={unicorn1}
            width="450" height="250"/>
            <div className= "dropdown-content">
       ...
       <li className= "dropdown"> 
          <img className="prework dropbtn" alt="prework img" src={Fitness}
            width="450" height="250"/>
            <div className= "dropdown-content">
       ...
       <li className= "dropdown"> 
          <img className="prework dropbtn" alt="prework img" src={empTkr}
            width="450" height="250"/>
            <div className= "dropdown-content">
       ...
       <li className= "dropdown"> 
          <img className="prework dropbtn" alt="prework img" src={teamprof}
            width="450" height="250"/>
            <div className= "dropdown-content">
